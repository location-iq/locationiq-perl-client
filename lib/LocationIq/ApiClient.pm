...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'LocationIq::Configuration' ) {
        $config = $_[0];
    } else {
        $config = LocationIq::Configuration->new(@_);
    }
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("LocationIq::Object::$class")->new;
        if (ref $data eq "HASH") {

...
#
package LocationIq::Object::DirectionsMatrix;
...
sub _deserialize {
    ...
    if ($type eq 'DateTime') {
        ...
        my $_instance = eval "LocationIq::Object::$type->new()";
...
__PACKAGE__->method_documentation({
    ...
    'fallback_speed_cells' => {
        datatype => 'ARRAY[double]',
        base_name => 'fallback_speed_cells',
        description => '',
        format => '',
        read_only => '',
            },
    'sources' => {
        datatype => 'ARRAY[DirectionsMatrixSources]',
        base_name => 'sources',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    ...
    'fallback_speed_cells' => 'ARRAY[double]',

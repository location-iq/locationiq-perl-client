...
#
package LocationIq::Configuration;
...
=head1 Name
        ...
        LocationIq::Configuration - holds the configuration for all LocationIq Modules
...
default: https://eu1.locationiq.com/v1
...
sub new {
    ...
    # base_url
    $p{base_url} //= 'https://eu1.locationiq.com/v1';

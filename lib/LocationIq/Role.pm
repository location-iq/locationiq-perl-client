...
has _cfg => ( is => 'ro',
              isa => 'LocationIq::Configuration',
              default => sub { LocationIq::Configuration->new() },
              );
...
sub _build_af {
    ...
    return LocationIq::ApiFactory->new(%args);
}
...
=head2 LocationIQ version: 1.1.0
